...
func CollectRouter(r *gin.RouterGroup) {
	...
	r.POST("articles/:id/collect", middleware.AuthMiddleware, app.ArticleCollectView)
	r.GET("collects/:id/articles", middleware.AuthMiddleware, app.CollectArticleListView)
}
